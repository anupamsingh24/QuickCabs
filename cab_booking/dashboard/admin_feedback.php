                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Feedback Received </h3>
                            </div>
                            <div class="panel-body">
                                <table class="table table-responsive table-hover">
                                    ...
                                    $sql = "SELECT * FROM feedback NATURAL JOIN book";
                                    $res = mysql_query($sql);
                                    ...
                                    while($row = mysql_fetch_assoc($res)){
                                        ...
                                        <tr>
                                            <?php 
                                                $que = "SELECT first_name,last_name FROM user WHERE id=$row[driver_id]";
