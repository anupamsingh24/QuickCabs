    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../dashboard/driver_index.php">Quick Cabs</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="driver_index.php"><i class="fa fa-fw fa-dashboard"></i> My Profile</a>
                    </li>
                    <li class="active">
                        <a href="assignment.php"><i class="fa fa-fw fa-bar-chart-o"></i> My Assignments</a>
                    </li>
                    <li>
                        <a href="driver_history.php"><i class="fa fa-fw fa-table"></i>Order History</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>Assignments </h3>
                            </div>
                            <div class="panel-body">
                                <table class="table table-responsive table-hover">
                                    ...
                                    $sql = "SELECT * FROM book WHERE driver_id='$_SESSION[SESS_MEMBER_ID]' AND completed=0";
                                    $res = mysql_query($sql);
                                    ...
                                    while($row = mysql_fetch_assoc($res)){
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-default"><a href="../Controllers/assignment.php?billnumber=<?php echo $row[bill_no]; ?>">Order Completed</a></button></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
