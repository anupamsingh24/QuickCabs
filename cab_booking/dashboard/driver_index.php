        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="driver_profile.php"><i class="fa fa-fw fa-bar-chart-o"></i> My Profile</a>
                    </li>
                    <li>
                        <a href="assignment.php"><i class="fa fa-fw fa-table"></i>New Assignments</a>
                    </li>
                    <li>
                        <a href="driver_history.php"><i class="fa fa-fw fa-edit"></i>Order History</a>
                    </li>
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Driver Details</h3>
                            </div>
