                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Change Pool Status For New Orders
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>Change Pool Status</h3>
                            </div>
                                ...
                                <table class="table table-responsive table-hover">
                                    ...
                                    while($row = mysql_fetch_assoc($res)){
                                        ...
                                        <tr>
                                            ...
                                            <form action="../Controllers/changepool.php?billno=<?php echo  $row[bill_no]; ?>" method="POST">
                                            <td>
                                            ...
                                            <td><button type="submit"  class="btn bg-primary">Change Pool Status</button></td>
                                            </form>
                                        </tr>
                                        <?php
                                    }
