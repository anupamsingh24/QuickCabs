        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li  class="active">
                        <a href="book.php"><i class="fa fa-fw fa-table"></i> Order History</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>Attended Orders</h3>
                            </div>
                            <div class="panel-body">
                                <table class="table table-responsive table-hover">
                                    ...
                                    $sql = "SELECT * FROM book WHERE driver_id=$_SESSION[SESS_MEMBER_ID] AND completed=1";
                                    $res = mysql_query($sql);
